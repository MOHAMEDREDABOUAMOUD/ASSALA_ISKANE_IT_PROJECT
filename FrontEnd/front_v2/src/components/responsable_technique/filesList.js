      ...
      <div className="content">
        ...
        <aside className="sidebar">
          <ul className="sidebar-menu">
            <li>
              <a href={`/absencesRT/${idProjet}`}>Liste des employés</a>
            </li>
            <li>
              <a href={`/materialsRT/${idProjet}`}>Liste des matériels</a>
            </li>
            <li>
              <a href={`/filesRT/${idProjet}`}>Liste des fichiers</a>
            </li>
            <li>
                <a href={`/needsRT/${idProjet}`}>Liste des besoins</a>
            </li>
            <li>
