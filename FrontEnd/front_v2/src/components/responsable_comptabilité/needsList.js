    ...
    const fetchNeeds = async () => {
      try {
        const response = await api.get(
          `http://localhost:9092/assalaiskane/getBesoinsRC?id_projet=${idProjet}`
        );
      ...
      <div className="content">
        ...
        <aside className="sidebar">
          <ul className="sidebar-menu">
            <li><a href={`/list-workersRC/${idProjet}`}>Liste des employés</a></li>
            <li><a href={`/materialsRC/${idProjet}`}>Liste des matériaux</a></li>
